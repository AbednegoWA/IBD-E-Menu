...
if(isset ($_SESSION['username'])){
  ...
  $query = "select * from tb_user natural join tb_level where id_user = $id_user";
    ...
    ?>
          ...
          <div class="widget-content nopadding" >
            <table class="table table-bordered table-invoice-full">
              ...
              <tbody>
                <?php
                  $no_order_fiks = 1;
                  $query_order_fiks = "select * from tb_pesan left join tb_masakan on tb_pesan.id_masakan = tb_masakan.id_masakan left join tb_order on tb_pesan.id_order = tb_order.id_order where id_user = $id_pemesan and status_pesan != 'sudah'";
                ...
                <tr>
                  ...
                  <td><?php echo $r_order_fiks['catatan'];?></td>
      ...
      <?php
          ...
          if(isset($_REQUEST['save_order'])){
            ...
            $query_save_transaksi = "update tb_order set id_admin = $id_user, uang_bayar = $uang_bayar, uang_kembali = $uang_kembali, status_order = 'sudah bayar' where id_order = $id_order";
