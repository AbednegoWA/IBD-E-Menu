    ...
    <div class="row-fluid">
              ...
              ?>
                <tr class="odd gradeX">
                  ...
                  <td>
                   ...
                   <td>
                    <center>
                      <input id="<?php echo "catatan".$r_draft_pesan['id_pesan']; ?>" class="span8" name="catatan<?php echo $r_draft_pesan['catatan']; ?>" type="text" value="" placeholder="" />
                    </center>
                  </td>
                  <td>
                    <form action="" method="post">
      ...
      <?php
          ...
          if(isset($_POST['proses_pesan'])){
            ...
            $time = Date('YmdHis');
            echo $time;
            $query_simpan_order = "insert into tb_order values('', '$id_admin', '$id_pengunjung', '$catatan', $time, '$no_meja', '$total_harga', '$uang_bayar', '$uang_kembali', '$status_order')";
