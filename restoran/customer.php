...
session_start();
ob_start();
if(isset($_GET['id'])&&isset($_GET['user'])&&isset($_GET['lvl'])){
...
<!--Header-part-->
<div id="header">
  <h1><a href="customer.php">Entri Order</a></h1>
</div>
<!--close-Header-part--> 
...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="customer.php" class="visible-phone"><i class="icon shopping-cart"></i> <span>Entri Order</span></a>
  <ul>
    <?php
    if($r['id_level'] == 1){
  ?>
  ...
  ?>
    <li class="active"> <a href="customer.php"><i class="icon icon-shopping-cart"></i> <span>Entri Order</span></a> </li>
  <?php
    }
  ?>
  </ul>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="customer.php" title="Go to here" class="tip-bottom"><i class="icon icon-tasks"></i> Entri Order</a></div>
  </div>
<!--End-breadcrumbs-->
